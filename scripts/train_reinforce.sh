#!/bin/bash
# Обучение REINFORCE. Все параметры скопированы из config/settings.py, меняется только модель.
...
# REINFORCE: REINFORCE_ENTROPY_COEF=0.01, REINFORCE_MAX_GRAD_NORM=50.0
ENTROPY_COEF=0.01
MAX_GRAD_NORM=50.0
