...
REINFORCE_MAX_GRAD_NORM = 50.0  # ограничение нормы градиента (None — без ограничения)
...
TRPO_MAX_ABS_ADVANTAGE = 10.0  # клиппинг |A_t| — иначе коллапс энтропии
TRPO_MAX_GRAD_NORM_CG = 50.0   # макс норма градиента до CG — стабильность шага
